from model_prob4 import ResNet34
import torch
import numpy as np
import torchvision
import tqdm
...
def main():
    ...
    #start Training
    trainer = Trainer(train_dataset, batchSize, epochs, loss='MSE')
    ...
    for epoch in tqdm.tqdm(range(epochs + 1)):
        ...
        if best_error == -1:
            ...
            torch.save(poseNet.state_dict(), "_".join(['/home/azatkariuly/CW4/', date, 'best_model.pth']))
        else:
